...
import { Pill, MapPin, ArrowRight, QrCode, Camera } from "lucide-react"
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-primary">
              <span className="text-primary">{t("findMedicineInfo")}</span>{" "}
              <span className="text-secondary">{t("instantly")}</span>
            </h1>
            ...
            {!isAuthenticated && !isLoading && (
              ...
              >
                <Button
                  size="lg"
                  className="text-base group relative overflow-hidden animate-pulse hover:animate-none"
      ...
      <section className="py-16 md:py-24 bg-muted/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="feature-card h-full cursor-pointer" onClick={() => router.push("/medicine-search")}>
              <CardHeader>
            ...
            <Card className="feature-card h-full cursor-pointer" onClick={() => router.push("/pharmacy-finder")}>
              <CardHeader>
            ...
            {/* New Feature Card: Medicine Scanner */}
            <Card className="feature-card h-full relative">
              ...
              <CardHeader>
                ...
                <CardTitle className="text-xl font-semibold">{t("medicineScan")}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription>{t("scanMedicineDescription")}</CardDescription>
              </CardContent>
            </Card>

            {/* New Feature Card: QR Code Information */}
            <Card className="feature-card h-full relative">
              <div className="absolute top-0 right-0 bg-primary text-white text-xs font-bold px-2 py-1 rounded-bl-lg rounded-tr-lg">
                {t("comingSoon")}
              </div>
              <CardHeader>
                ...
                <CardTitle className="text-xl font-semibold">{t("qrCodeInfo")}</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-8 md:p-12 flex flex-col items-center text-center">
            ...
            <div className="mt-8 flex gap-4">
              <Button size="lg" onClick={() => router.push("/medicine-search")}>
                {t("medicineSearch")}
              </Button>
              <Button size="lg" variant="outline" onClick={() => router.push("/pharmacy-finder")}>
                {t("pharmacyFinder")}
              </Button>
            </div>
          </div>
